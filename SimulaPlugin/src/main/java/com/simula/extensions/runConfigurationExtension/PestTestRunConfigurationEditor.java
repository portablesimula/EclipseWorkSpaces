...
public class PestTestRunConfigurationEditor extends SettingsEditor<SimulaRunConfiguration> {
...
//    public PestTestRunConfigurationEditor(PhpTestRunConfigurationEditor parentEditor, SimulaRunConfiguration settings){
    public PestTestRunConfigurationEditor(SimulaRunConfiguration settings){
