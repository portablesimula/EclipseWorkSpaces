...
public final class RunSingleTest {
	...
	private static final File userDir=new File("C:/GitHub/EclipseWorkSpaces/SimulaCompiler2/SimulaTestBatch2");
...
//		names.add("simerr09.sim"); // OK: Read/write access on DirectFile and DirectByteFile
		names.add("simerr10.sim"); // OK: Integer Multiply Overflow
