...
javadoc --release 24 --enable-preview -author -private -d C:\GitHub\github.io\javadoc -sourcepath C:\GitHub\EclipseWorkSpaces\SimulaCompiler2\Simula\src -subpackages simula
pause
