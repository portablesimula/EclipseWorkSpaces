...
//		Global.verbose = true;
		BecGlobal.traceMode = 4;
		BecGlobal.SCODE_INPUT_TRACE = true;
		BecGlobal.PRINT_GENERATED_SVM_CODE = true;
		BecGlobal.ATTR_INPUT_TRACE = true;
		BecGlobal.ATTR_OUTPUT_TRACE = true;
...
//		return "C:/GitHub/EclipseWorkSpaces/S-Port-Simula/FILES/simulaRTS/SCode/MNTR.scd";
	...
	private static String Pick_FEC_Source() {
		BecGlobal.outputDIR = "C:/SPORT/TEST_BATCH/";
