...
public class Segment { // extends Descriptor {
	...
	public Segment(String ident, int segmentKind) {
		if(BecGlobal.SEGMAP.get(ident) != null) Util.IERR("Segment allready defined: " + ident);
		this.ident = ident.toUpperCase();
		BecGlobal.SEGMAP.put(this.ident, this);
	...
	public static Segment find(String ident) {
		return BecGlobal.SEGMAP.get(ident);
	}

	public static Segment lookup(String ident) {
		Segment seg = BecGlobal.SEGMAP.get(ident);
		if(seg == null) {
...
//	}
	...
	public static void listAll() {
		for(Segment seg:BecGlobal.SEGMAP.values()) {
	...
	public static void main(String[] args) {
		...
		BecGlobal.CSEG = new DataSegment("CSEG", Kind.K_SEG_CONST);
		BecGlobal.DSEG = new DataSegment("DSEG", Kind.K_SEG_DATA);
