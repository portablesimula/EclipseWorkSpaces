...
//			CTStack.dumpStack("DSIZE.ofScode: ");
			...
			BecGlobal.PSEG.emit(new SVM_LOADC(Type.T_INT, nbrepValue), "DSIZE'nbrep: ");
			BecGlobal.PSEG.emit(new SVM_MULT(), "MULT: ");
			IntegerValue fixValue = IntegerValue.of(Type.T_INT, fixrec.size);
			BecGlobal.PSEG.emit(new SVM_LOADC(Type.T_INT, fixValue), "DSIZE'recSize: ");
			BecGlobal.PSEG.emit(new SVM_ADD(), "ADD: ");
