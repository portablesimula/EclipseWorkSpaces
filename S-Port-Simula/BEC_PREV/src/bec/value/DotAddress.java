...
//			System.out.println("DotAddress.ofScode: descr=" + descr);
			Attribute attr = (Attribute) BecGlobal.getMeaning(aTag);
			offset += attr.rela;
//			System.out.println("DotAddress.ofScode: " + attr + "  offset="+offset);
		...
		switch(terminator) {
			case Scode.S_C_AADDR:{
				Attribute attr = (Attribute) BecGlobal.getMeaning(globalOrConstTag);
...
//				return new GeneralAddress(var.address, offset);
				Descriptor descr = BecGlobal.getMeaning(globalOrConstTag);
