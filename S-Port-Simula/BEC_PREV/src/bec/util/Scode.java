...
//		INIT_TAGTABLE.INIT();
		...
		String fileName = BecGlobal.scodeSource;
...
//				CTStack.dumpStack("Scode.flushTraceBuff");
		...
		if(BecGlobal.PRINT_GENERATED_SVM_CODE) {
			if(BecGlobal.PSEG != null) BecGlobal.PSEG.listInstructions();
		}
	}
...
//		String fileName = "C:/GitHub/EclipseWorkSpaces/S-Port-Simula/SimulaFEC/src/fec/source/RTS-FEC-TAGTABLE.def";
//		try {
