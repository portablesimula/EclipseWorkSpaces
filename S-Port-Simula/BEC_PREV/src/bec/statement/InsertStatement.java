...
//		Util.IERR("");
	...
	private void readDescriptors(boolean sysmod) throws IOException {
		...
		if(sysmod) {
			fileName = BecGlobal.rtsDir+modid+".svm";
//			Util.IERR(""+modid+"  "+Global.rtsDir);
		} else {
			fileName = BecGlobal.getAttrFileName(modid, ".svm");
		}
		if(BecGlobal.ATTR_INPUT_TRACE) System.out.println("ATTRIBUTE INPUT: " + fileName);
