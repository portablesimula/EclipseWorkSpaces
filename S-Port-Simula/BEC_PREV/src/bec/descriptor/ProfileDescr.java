...
//		System.out.println("NEW ProfileDescr: " + tag);
	...
	public String dsegIdent() {
		return "DSEG_" + BecGlobal.moduleID + '_' + tag.ident();
...
//		Util.IERR("");
	...
	public void write(AttributeOutputStream oupt) throws IOException {
		if(BecGlobal.ATTR_OUTPUT_TRACE) System.out.println("ProfileDescr.Write: " + this);
...
//		oupt.writeString(DSEG.ident);
	...
	public static ProfileDescr read(AttributeInputStream inpt) throws IOException {
		...
		if(BecGlobal.ATTR_INPUT_TRACE) System.out.println("BEGIN ProfileDescr.Read: " + prf);
		...
		if(BecGlobal.ATTR_INPUT_TRACE) System.out.println("ProfileDescr.Read: " + prf);
//		prf.print("   ");
//		Util.IERR("");
		return prf;
	}
