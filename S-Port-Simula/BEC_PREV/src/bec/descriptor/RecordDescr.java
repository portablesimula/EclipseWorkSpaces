...
//		rec.print("    ");
	...
	private RecordDescr getPrefix(int prefixTag) {
		RecordDescr prefix = (RecordDescr) BecGlobal.DISPL.get(prefixTag);
		return prefix;
	}
	...
	public void write(AttributeOutputStream oupt) throws IOException {
		if(BecGlobal.ATTR_OUTPUT_TRACE) System.out.println("RecordDescr.Write: " + this);
		oupt.writeKind(kind);
		tag.write(oupt);
	...
	public static RecordDescr read(AttributeInputStream inpt) throws IOException {
		...
		if(BecGlobal.ATTR_INPUT_TRACE) System.out.println("RecordDescr.Read: " + rec);
		return rec;
	}
