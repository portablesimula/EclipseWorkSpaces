...
public final class ConsolePanel2 extends JPanel {
	
	public static ConsolePanel2 current;
    ...
    /// @param args the arguments
     public static void main(String[] args) {
         ...
         ConsolePanel2 console = new ConsolePanel2();
     	 frame.add(console);
		...
		if (consoleReader == null) {
			consoleReader = new Reader() {
				...
				public int read(final char[] cbuf, final int off, final int len) throws IOException {
					...
					ConsolePanel2.this.requestFocusInWindow();
					System.out.println("ConsolePanel'read: ");
					
					// while(reading) Thread.yield();
					while (ConsolePanel2.this.read() != '\n')
						;
...
//		    	System.out.println("ConsolePanel'OutputStream.write: " + s);
				ConsolePanel2.this.write(s, styleRegular);
			}
		    @Override
	...
	public Writer getWriter() {
		return (new Writer() {
			...
			public void write(String s) {
				ConsolePanel2.this.write(s);
				ConsolePanel2.this.repaint();
			}

			public void write(char[] cbuf, int off, int len) throws IOException {
				ConsolePanel2.this.write(new String(cbuf, off, len));
				ConsolePanel2.this.repaint();
			}
