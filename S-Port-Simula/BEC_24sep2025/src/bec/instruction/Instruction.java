...
//		IO.println("Parse.instruction: "+Scode.curinstr);
		switch(Scode.curinstr) {
			...
			case Scode.S_SETSWITCH ->   Util.IERR("NOT IMPLEMENTED: " + Scode.curinstr); //  SetSwitch
			case Scode.S_INFO ->        Util.IERR("NOT IMPLEMENTED: " + Scode.curinstr); //       Ed(errmsg,InString); WARNING("Unknown info: ");
