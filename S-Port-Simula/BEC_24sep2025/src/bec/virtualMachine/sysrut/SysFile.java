...
import bec.virtualMachine.rtfiles.RTDirectBytefile;
import bec.virtualMachine.rtfiles.RTDirectfile;
import bec.virtualMachine.rtfiles.RTFile;
import bec.virtualMachine.rtfiles.RTFileAction;
import bec.virtualMachine.rtfiles.RTImageFile;
import bec.virtualMachine.rtfiles.RTInbytefile;
import bec.virtualMachine.rtfiles.RTInfile;
import bec.virtualMachine.rtfiles.RTOutbytefile;
import bec.virtualMachine.rtfiles.RTOutfile;
import bec.virtualMachine.rtfiles.RTPrintfile;
...
//		IO.println("SysFile.lookup: key="+key);
	...
	public static void gdspec() {
		...
		DataAddress itemAddr = RTStack.popGADDRasOADDR();
...
//		String image = RTStack.popString();
		...
		DataAddress chrAddr = RTStack.popGADDRasOADDR();
		int key = RTStack.popInt();
