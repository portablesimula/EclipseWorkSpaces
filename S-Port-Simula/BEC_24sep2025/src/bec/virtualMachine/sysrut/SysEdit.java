...
//		SegmentAddress valAddr = RTStack.popGADDRasOADDR();
		DataAddress valAddr = RTStack.popGADDRasOADDR();
//		if(DEBUG) {
//			valAddr.segment().dump("SVM_SYSCALL.putstr:");
//			IO.println("SVM_SYSCALL.putstr: valAddr="+valAddr.getClass());
...
//		IO.println("SysEdit.putreal: "+val);
	...
	public static void ptoadr2() {
		...
		SegmentAddress val = (SegmentAddress) RTStack.popOADDR();
		int itemNchr = RTStack.popInt();
		DataAddress itemAddr = RTStack.popGADDRasOADDR();
