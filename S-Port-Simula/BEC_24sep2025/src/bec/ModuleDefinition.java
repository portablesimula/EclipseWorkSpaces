...
//		IO.println("ModuleDefinition: TAGTAB Read");
...
//		IO.println("ModuleDefinition: curinstr="+Scode.curinstr);
		LOOP: while(true) {
...
//					Util.IERR("SJEKK DETTE");
					break;
				default:
//					IO.println("ModuleDefinition'LOOP: Terminated by: " + Scode.curinstr);
					break LOOP;
			}
			Scode.inputInstr();
//			IO.println("ModuleDefinition: +++++++++++++ REPEAT: "+Scode.curinstr);
		}

		programElements();

		if(Scode.curinstr != Scode.S_ENDMODULE) Util.IERR("Improper termination of module: "+Scode.curinstr);
...
//		IO.println("MONITOR.viisible: CurInstr="+Scode.curinstr);
		switch(Scode.curinstr) {
			...
			default:
//				IO.println("MONITOR.viisible: CurInstr="+Scode.curinstr + " TERMINATES VIISIBLE");
				return false;
		}
		return true;
	}
