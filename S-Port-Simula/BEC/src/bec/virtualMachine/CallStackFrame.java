...
//			while(idx < RTStack.size()) {
//				Value item = RTStack.load(idx);
//				IO.println(indent+"STACK:  " + idx + ": " + item.value()); idx++;			
//			}
		} catch(Exception e) {}
...
//				for(int i=0;i<exportSize;i++) {
//					Value item = RTStack.load(idx);
//					IO.println(indent+"EXPORT: " + idx + ": " + item.value()); idx++;
//				}
//			}
//			for(int i=0;i<importSize;i++) {
//				Value item = RTStack.load(idx);
//				IO.println(indent+"IMPORT: " + idx + ": " + item.value()); idx++;
//			}
//			IO.println(indent+"RETURN: " + idx + ": " + RTStack.load(idx)); idx++;
//			for(int i=0;i<localSize;i++) {
//				Value item = RTStack.load(idx);
//				IO.println(indent+"LOCAL:  " + idx + ": " + item.value()); idx++;
//			}
//			while(idx < RTStack.size()) {
//				Value item = RTStack.load(idx);
//				IO.println(indent+"STACK:  " + idx + ": " + item.value()); idx++;			
