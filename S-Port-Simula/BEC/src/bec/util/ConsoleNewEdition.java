...
public class ConsoleNewEdition extends JFrame {
	
	public static ConsoleNewEdition current;
	...
	public static void main(String[] args) throws IOException {
		ConsoleNewEdition console = new ConsoleNewEdition();
