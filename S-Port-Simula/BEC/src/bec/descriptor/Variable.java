...
//			System.out.println("NEW Global Variable: " + Scode.edTag(var.tag) + " " + var.quant + " SYSTEM " + system);
			...
			else if(system.equalsIgnoreCase("ITSIZE")) value = null;//IntegerValue.of(0);
			else if(system.equalsIgnoreCase("MAXLEN")) value = IntegerValue.of(Type.T_SIZE, 20);
			else if(system.equalsIgnoreCase("INPLTH")) value = IntegerValue.of(Type.T_INT, 80);
			else if(system.equalsIgnoreCase("OUTLTH")) value = IntegerValue.of(Type.T_INT, 172);
			...
			else if(system.equalsIgnoreCase("MAXRNK")) value = IntegerValue.of(Type.T_INT, Byte.MAX_VALUE);
