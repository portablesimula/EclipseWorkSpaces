...
//		String scodeSource = Pick_FEC_Source();
		Option.GENERATE_DEBUG_CODE = true;
		Option.GENERATE_Q_CODE = true;
		
		Option.verbose = true;
//		Option.traceMode = 4;
//		Option.DISPL_TRACE = true;
		Option.SCODE_INPUT_TRACE = true;
		Option.SCODE_INPUT_DUMP = true;
...
//		Option.SEGMENT_OUTPUT_DUMP = true;
		...
		Option.listq1 = 4; // Output Q-code 1 listing switch
//		Option.listq2 = 4; // Output Q-code 2 listing switch


		BEC_Compiler.doCompile(scodeSource);
	}
