...
//	           if UnAlligned(%qi qua Qfrm4.aux.LO%)
	      ...
	      case qLOADC: //---- LOADC   reg const ----------------- Format 2
	           ...
	           break;
// %-E    case qLOADSC: ----- LOADSC  sreg reg fld addr --------- Format 2b
