...
//		RTStack.printCallStack("RTStack.popGADDRasOADDR:");
		...
		DataAddress base = (DataAddress) RTStack.pop();
//		int ofst = RTStack.popInt();
...
//		System.out.println("RTStack.popGADDRasOADDR: chradr="+chradr+", ofst="+ofst);
	...
	public static DataAddress popGADDRasOADDR() {
//		RTStack.dumpRTStack("RTStack.popGADDRasOADDR:");
//		RTStack.printCallStack("RTStack.popGADDRasOADDR:");
		int ofst = RTStack.popInt();
//		System.out.println("RTStack.popGADDRasOADDR: ofst="+ofst);
		DataAddress chradr = (DataAddress) RTStack.pop();
//		System.out.println("RTStack.popGADDRasOADDR: chradr="+chradr+", ofst="+ofst);
		if(chradr == null) {
			if(ofst != 0) Util.IERR("");
			return null;
...
//		System.out.println("RTStack.popOADDR; frmx="+frmx);
	...
	public static DataAddress popOADDR() {
		try {
			DataAddress oadr = (DataAddress) RTStack.pop();
...
//		int ofst = RTStack.popInt();
//		DataAddress chradr = (DataAddress) RTStack.pop();
//		DataAddress x = chradr.ofset(ofst);
		DataAddress oaddr = RTStack.popGADDRasOADDR();
		if(oaddr == null) {
			if(nchr != 0) Util.IERR("");
			return null;
		}
		SegmentAddress x = (SegmentAddress) oaddr.copy();
