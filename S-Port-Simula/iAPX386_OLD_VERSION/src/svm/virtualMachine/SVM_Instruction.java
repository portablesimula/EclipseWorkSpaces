...
public class SVM_Instruction {
	...
	public final static int iPUSHGADR = 47;
	public final static int iEVAL = 48;
	public final static int iFIXREM = 49;
...
//		IO.println("SVM_Instruction.read: opcode="+edOpcode(opcode));
		switch(opcode) {
			...
			case iPUSHGADR:	return SVM_DEREF.read(inpt);
			case iEVAL:		return SVM_EVAL.read(inpt);
			case iFIXREM:   return SVM_FIXREMOTE.read(inpt);
	...
	public static String edOpcode(int opcode) {
		switch(opcode) {
			...
			case iPUSHGADR:	return "iPUSHGADR";
			case iEVAL:		return "iEVAL";
			case iFIXREM:   return "iFIXREMOTE";
