...
//			String name ="SimulaTest";
//		String name ="simtst20";
//		String name ="simtst21";
//		String name ="simtst22";
//		String name ="simtst23";
//		String name ="simtst24";
//		String name ="simtst25";
//		String name ="simtst26"; // SORRY, switch element requiring thunk IS NOT IMPLEMENTED
//		String name ="simtst27";
//		String name ="simtst28";
//		String name ="simtst29";
//		String name ="simtst30a"; // FEILER
//		String name ="simtst30";  // FEILER
//		String name ="simtst31";  // SORRY, complex switch element IS NOT IMPLEMENTED
//		String name ="simtst32";  // FEILER THUNK
//		String name ="simtst33";
//		String name ="simtst34";  // FEILER
//		String name ="simtst35";  // FEILER THUNK
//		String name ="simtst36";  // FEILER THUNK
//		String name ="simtst37";
//		String name ="simtst38";
//		String name ="simtst39";
//		String name ="p40b"; // Precompile this for Simtst 40.
//		String name ="p40a"; // Precompile this for Simtst 40.
//		String name ="p40c"; // Precompile this for Simtst 40.
//		String name ="simtst40";  // FEILER
//		String name ="p41";  // Precompile this for Simtst 41.
//		String name ="simtst41";  // FEILER
//		String name ="simtst42";
//		String name ="simtst43";
//		String name ="simtst44";
//		String name ="simtst45";
//		String name ="simtst46";
//		String name ="simtst47";
//		String name ="simtst48";
//		String name ="simtst49";
...
//		names.add("simtst30a"); // ERR:  Simple test of Arrays.
//		names.add("simtst30"); // ERR:  Name parameters (Modified: 2-dim arrays removed)
//
//		names.add("simtst31"); // OK:  Labels and switches as parameters to procedures.  // SORRY, complex switch element IS NOT IMPLEMENTED
//		names.add("simtst32"); // ERR:  Simple test of formal procedures.
//		names.add("simtst33"); // OK:  Test call by reference
//		names.add("simtst34"); // ERR:  Procedures with procedures as parameters.
//		names.add("simtst35"); // ERR:  Type procedures as parameters.
//		names.add("simtst36"); // ERR:  Jensens Device - call by name.
...
//		names.add("simtst53"); // ERR:  Syntax check on virtual part
//		names.add("simtst54"); // OK:  A VERY Simple Simulation
//		names.add("simtst55"); // ERR:  Test virtual procedures.
//		names.add("simtst56"); // ERR:  Test virtual procedures.
//		names.add("simtst57"); // ERR:  Virtual procedure - different number of parameters
...
//		names.add("simtst63"); // ERR:  Transmission by name of reference types. 
...
//		
//		names.add("simtst71"); // ERR:  Test visibility of identifiers.
...
//		names.add("simtst75"); // ERR:  Name parameters and virtual procedures.
//		names.add("simtst76"); // OK:  Test of detach and resume in SIMSET.
//		names.add("simtst77"); // ERR:  Two infile objects reading from the same external file.
...
//		names.add("Separat");  // ERR:  Precompile this for Simtst 86.
//		names.add("simtst86"); // ERR:  Simple Test of Separately Compiled Class.
//		names.add("simtst87"); // ERR:  Specification of Virtual Procedures.
...
//
//		names.add("simtst91"); // ERR:  Test virtual procedures, simple case.
...
//		names.add("simtst99");  // ERR: Test mod, rem, min, max.
//		names.add("simtst100"); // OK: Test that put-get-put delivers the identity.  Uses GOTO/LABEL
//
		names.add("simtst101"); // ERR:  Test Standard Procedure 'sourceline'.
//		names.add("simtst102"); // ERR: GOTO out of an operating Process
...
//
//		names.add("simtst111"); // ERR: Virtual Label Sample 1
//		names.add("simtst112"); // ERR: Virtual Label Sample 2
...
//		names.add("ExternalClass1");      // ERR:  Precompile this for Simtst 119.
//		names.add("ExternalClass2");      // ERR:  Precompile this for Simtst 119.
//		names.add("simtst119"); // ERR: Uses EcternalClass1-2
...
//		names.add("simtst124"); // ERR: GOTO VIRTUAL LABEL
...
//		names.add("simtst141"); // ERR: Test For-Statement with SIMSET and SIMULATION list-processing.
//		names.add("simtst142"); // ERR: Simple test of Random drawing procedures.
//		names.add("simtst143"); // ERR: Simple test of utility procedure accum.
...
//		names.add("simtst146"); // ERR: Test text by value to formal and virtual procedure
//		names.add("simtst147"); // ERR: Test virtual procedure by name
//		names.add("simtst148"); // ERR: Test procedure min and max with arguments of all types
//		names.add("simtst149"); // ERR: Test all mode/type parameters to a Class
//		names.add("simtst150"); // ERR: Test all mode/type parameters except name, ... to a Procedure
//		names.add("simtst151"); // ERR: Test multiple assignments
//		names.add("simtst152"); // OK: Test nested connection statements
//		names.add("simtst153"); // OK: Test GOTO ConditionalExpression
//		names.add("simtst154"); // ERR: Test function result assignment
//		names.add("Pre155");    // ERR: Precompile this for Simtst 155.
//		names.add("simtst155"); // ERR: Test
//		names.add("simtst156"); // ERR: Test arrays in multiple assignments
//		names.add("simtst157"); // ERR: Test identifier access
//		names.add("simtst158"); // ERR: Test Specified Virtual Boolean Functions as part of an Expression
//		names.add("simtst159"); // ERR: Test Specified Virtual Real Functions as part of an Expression

//		names.add("simtst160"); // ERR: Test Specified Virtual Text Functions as part of an Expression
