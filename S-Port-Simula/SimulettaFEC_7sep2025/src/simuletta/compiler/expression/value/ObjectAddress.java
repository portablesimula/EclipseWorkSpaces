 ...
 *  S-Code:
 *  
 *  	DataAddress ::= ONONE  |  C_OADDR global_or_const:tag
 * 
 * </pre>
 * 
 ...
 */
public class DataAddress extends Value {
	public final String ident;
	
	public DataAddress(String ident) {
		this.ident=ident;
	}
...
//				System.out.println("DataAddress.doOutConst: ONONE");
				return(Type.Ref);
			}
...
//			System.out.println("DataAddress.doOutConst: q="+q);
		exitLine();
