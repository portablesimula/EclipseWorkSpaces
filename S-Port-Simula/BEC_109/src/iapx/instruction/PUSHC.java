...
import iapx.value.DotAddress;
import iapx.value.GeneralAddress;
import iapx.value.IntegerValue;
import iapx.value.LongRealValue;
import iapx.value.MemAddr;
import iapx.value.ProgramAddress;
import iapx.value.RealValue;
import iapx.value.RecordValue;
import iapx.value.SegmentAddress;
...
public abstract class PUSHC extends Instruction {
	...
	public static void ofScode() {
		...
		switch(Scode.curinstr) {
		    ...
		    case Scode.S_C_OADDR:  type = Type.T_OADDR; value = MemAddr.ofScode(); break;
