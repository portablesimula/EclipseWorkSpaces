...
public class Segment { // extends Descriptor {
	public String ident;
	protected Kind segmentKind; // K_SEG_DATA, K_SEG_CONST, K_SEG_CODE
	private int segmentIndex;
	private static int SEQU = 1;

	public Segment(String ident, Kind kSegData) {
		if(SEGMAP.get(ident) != null) Util.IERR("Segment allready defined: " + ident);
		this.ident = ident.toUpperCase();
		SEGMAP.put(this.ident, this);
